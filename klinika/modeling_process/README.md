...
## 📄 Ключевые артефакты
- **[AS-IS BPMN модель процесса приёма у врача](AS-IS_BPMN.pdf)**
...
## 🏆 Результат
Подготовлены AS-IS и TO-BE модели процессов для сети клиник «Вита». Описаны состояния записи и действия, которые можно автоматизировать. Разработан целевой процесс онлайн-записи, который:
